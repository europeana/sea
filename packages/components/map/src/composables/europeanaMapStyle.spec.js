...
import { useEuropeanaMapStyle } from "./europeanaMapStyle.js";

describe("@/composables/mapbox/versatilesStyle.js", () => {
  describe.each([
    {
      styleName: "protomaps",
      baseURL: undefined,
      ...
      version: undefined,
      expected:
        "https://cdn.jsdelivr.net/npm/@europeana/map-styles/dist/protomaps/europeana-map-styles.protomaps.json",
    },
    {
      styleName: "protomaps",
      baseURL: undefined,
      ...
      version: "0.1.13",
      expected:
        "https://cdn.jsdelivr.net/npm/@europeana/map-styles@0.1.13/dist/protomaps/europeana-map-styles.protomaps.json",
    },
    {
      styleName: "protomaps",
      baseURL: undefined,
    ...
    },
    {
      ...
      version: undefined,
      expected:
        "https://unpkg.com/@europeana/map-styles/dist/protomaps/europeana-map-styles.protomaps.json",
    },
    {
      styleName: "protomaps",
      baseURL: "https://unpkg.com",
      ...
      version: "0.1.13",
      expected:
        "https://unpkg.com/@europeana/map-styles@0.1.13/dist/protomaps/europeana-map-styles.protomaps.json",
    },
    {
      styleName: "protomaps",
      baseURL: "https://unpkg.com",
